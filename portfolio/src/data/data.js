	...
	},
	{
		...
		skills: [
			...
			},
			{
				name: 'SNS',
				image:
					'https://static-00.iconduck.com/assets.00/aws-sns-icon-2044x2048-y07e5ihi.png',
			},
			{
				name: 'Lambda',
			...
			{
				name: 'CloudFront',
				image: 'https://cdn.worldvectorlogo.com/logos/aws-cloudfront.svg',
			},
			{
				name: 'RDS',
				image:
					'https://static-00.iconduck.com/assets.00/aws-rds-icon-227x256-fafrjqlm.png',
			},
			{
				name: 'IAM',
				image: 'https://cdn.worldvectorlogo.com/logos/aws-iam.svg',
			},
			{
				name: 'API Gateway',
				image:
					'https://static-00.iconduck.com/assets.00/aws-api-gateway-icon-212x256-i2aae0yi.png',
			},
			{
				name: 'Auto Scaling',
				image:
					'https://upload.wikimedia.org/wikipedia/commons/thumb/d/dd/AWS_Simple_Icons_Compute_Amazon_Elastic_MapReduce_Auto_Scaling.svg/1024px-AWS_Simple_Icons_Compute_Amazon_Elastic_MapReduce_Auto_Scaling.svg.png',
			},
		],
	},
	{
		...
		skills: [
			...
			{
				name: 'Adobe XD',
				image: 'https://www.svgrepo.com/show/303109/adobe-xd-logo.svg',
			},
			{
				name: 'Figma',
				image:
			...
			{
				name: 'SourceTree',
				image: 'https://cdn.worldvectorlogo.com/logos/sourcetree-1.svg',
			},
			{
				name: 'VS Code',
				image:
...
export const education = [
	{
		id: 0,
		img: 'https://firebasestorage.googleapis.com/v0/b/portfolio-377d8.appspot.com/o/sheridan.png?alt=media&token=38f8e051-6530-4532-adba-bf78da957d80',
		school: 'Sheridan College, Brampton, Canada',
		date: 'Sep 2019 - Dec 2020',
		grade: 'GPA 3.21 / 4.0',
		desc: 'Coursework included knowledge-gathering, schedule planning, problem-solving, technical communication, project management and comprise emerging technologies such as web development, frameworks, UX / UI designs, computation, algorithms, coding, debugging, testing, and deployment.',
		degree: 'Diploma in Computer Programming',
	},
	{
		id: 1,
		img: 'https://firebasestorage.googleapis.com/v0/b/portfolio-377d8.appspot.com/o/ldrp_logo.8d75ed5682122b6a17ec.png?alt=media&token=8a1cf7dd-6b70-4c03-97c3-2f8a13ccec79',
		school: 'LDRP Institute of Technology and Research, Gandhinagar, India',
		date: 'Apr 2014 - Apr 2018',
		grade: 'CGPA 7.59 / 10.0',
		desc: 'Gained vast information of the operating system, design and analysis of algorithm, programming languages, computer software, mobile communication, database management system, internet of things, artificial intelligence, cryptography and network security.',
		degree: 'Bachelors in Computer Engineering - First Class with Distinction',
	},
];
...
export const TimeLineData = [
	...
	{
		year: 2022,
		text: 'Started a new role as an Intermediate Software Developer for a year and 10 months',
	},
];
